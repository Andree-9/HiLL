...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def update_actor(self, data: DataProto):
        ...
        # Clear CUDA cached memory after training so reasoner/hinter
        # colocation has headroom for subsequent rollout/generation.
        aggressive_empty_cache(force_sync=True)
        log_gpu_memory_usage("After empty_cache in update_actor", logger=logger)
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        aggressive_empty_cache(force_sync=True)
        log_gpu_memory_usage("After empty_cache in compute_log_prob", logger=logger)
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        aggressive_empty_cache(force_sync=True)
        log_gpu_memory_usage("After empty_cache in compute_ref_log_prob", logger=logger)
